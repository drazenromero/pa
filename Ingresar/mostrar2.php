	...
	<html>
		...
		<body>
			<div height="300" id="frame1">
				...
				$sql = "SELECT * FROM mercancia where code_producto like '%$_GET[buscar_producto_nombre]%'";
				mysqli_query($conexion, $sql);
				$cantidad_registros= mysqli_affected_rows($conexion);
				print"Número de coincidencias: ".$cantidad_registros;
				//Seccion para mostrar cierta cantidad de elementos
				$tamaño_paginas = 2;
				...
				$sql2 = "SELECT * FROM mercancia where code_producto like '%$_GET[buscar_producto_nombre]%' limit $to,$tamaño_paginas";
